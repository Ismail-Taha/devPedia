...
* [ariera/DevPedia-template](https://github.com/ariera/DevPedia-template)
* [vchaptsev/cookiecutter-DevPedia](https://github.com/vchaptsev/cookiecutter-DevPedia)

Prefer Flask? Checkout my [gtalarico/flask-vuejs-template](https://github.com/gtalarico/flask-vuejs-template)

### Demo

[Live Demo](https://DevPedia-template-demo.herokuapp.com/)
...
```
$ heroku apps:create DevPedia-template-demo
$ heroku git:remote --app DevPedia-template-demo
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/gtalarico/DevPedia-template)
...
[Cloudfront Setup Wiki](https://github.com/gtalarico/DevPedia-template/wiki/Setup-CDN-on-Cloud-Front)
